                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control text-muted @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus readonly>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('login') }}" class="btn btn-link link-danger">
                                    {{ __('Cancel') }}
                                </a>
                            </div>
                        </div>
