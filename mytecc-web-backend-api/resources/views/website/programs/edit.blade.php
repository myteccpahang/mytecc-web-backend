        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body p-5">
                    <form action="{{ route('website.programAndActivity.update', $program->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="form-group mb-2">
                            <label for="title">Program Title</label>
                            <input type="text" value="{{ (old('title')) ? old('title') : $program->title }}" class="form-control" id="title" name="title">
                            @if ($errors->any('title'))
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" value="{{ (old('place')) ? old('place') : $program->place }}" class="form-control" id="place" name="place">
                            @if ($errors->any('place'))
                                <span class="text-danger" role="alert">
                                    {{ $errors->first('place') }}
                                </span>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" value="{{ (old('program_director')) ? old('program_director') : $program->program_director }}" class="form-control" id="program_director" name="program_director">
                        ...
                        <div class="row g-2 mb-2">
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" value="{{ (old('date')) ? old('date') : $program->date }}" class="form-control" id="date" name="date">
                                @if ($errors->any('index'))
                                    <span class="text-danger" role="alert">
                                        {{ $errors->first('date') }}
                                    </span>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="time" value="{{ (old('start_time')) ? old('start_time') : $program->start_time }}" class="form-control" id="start_time" name="start_time">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="time" value="{{ (old('end_time')) ? old('end_time') : $program->end_time }}" class="form-control" id="end_time" name="end_time">
